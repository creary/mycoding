...
public class LogUtil {
  ...
  public static final String LOG4J_PROPERTIES = StringUtil.isValidObj(ResourcesUtil.getVbyKey("src")) ? ResourcesUtil.getVbyKey("src")+"\\log4j.properties" : "log4j.properties";

  public static final String LOG_FOLDER = StringUtil.isValidObj(ResourcesUtil.getVbyKey("log")) ? ResourcesUtil.getVbyKey("log") :"log"; //日志目录，系统启动时自动创建

  public static final String ERROR_LOG = StringUtil.isValidObj(ResourcesUtil.getVbyKey("filename")) ? ResourcesUtil.getVbyKey("filename")+".log" :"error.log" ;
