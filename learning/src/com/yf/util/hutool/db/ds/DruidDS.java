package com.yf.util.hutool.db.ds;
...
import com.yf.util.hutool.FileUtil;
import com.yf.util.hutool.Log;
import com.yf.util.hutool.Setting;
import com.yf.util.hutool.StrUtil;
import com.yf.util.hutool.db.DbUtil;
import com.yf.util.hutool.db.dialect.DialectFactory;
import com.yf.util.hutool.exceptions.SettingException;
import com.yf.util.hutool.exceptions.UtilException;
...
public class DruidDS {
	...
	/** 默认的Druid配置文件路径 */
	public final static String DEFAULT_DRUID_CONFIG_PATH = "DB.properties";
	/** 默认的数据库连接配置文件路径 */
	public final static String DEFAULT_DB_CONFIG_PATH = "DB.properties";
	/** 默认的数据库连接驱动（MySQL） */
	...
	synchronized public static DataSource getDataSource(String group) {
		...
		final String jdbcUrl = dbSetting.getString("jdbcUrl", group);
